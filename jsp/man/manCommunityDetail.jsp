...
<%
    ...
    try{
        ...
        String sql="select * from BULLETIN_BOARD where NWNum=?";
  ...
  <body>
    ...
    <div class="CommunityDetail">
      ...
      <div class="write">
        ...
        <form action="manCommunityDelete.jsp" id="frm1" class="submit">
        	<!-- 삭제하려는 게시판의번호를 셋팅  -->
        	<input type="hidden" name="<%=NWNum%>"/>
          	<button onclick="javascript:manCommunityDelete();">삭제하기</button>
        </form>
      </div>
