...
<h1>네비게이션바</h1>
    ...
    <form action="orgDeleteOrderList.jsp" method="post">
	    <div style="margin-top:2%; font-weight:bold; font-size:20px; text-align:center;">	
    		<input type="text" class="deltext" name="delOrderNum" placeholder="취소할 주문의 주문번호를 입력하세요.">
            	<button class="rectangle_btn" type="submit">취소하기</button>
    	</div>
    </form>
<%
   ...
   try {
       // VarietyID 구하기
       String sql = "SELECT OrderNum, OD_UserID, SeedName, VarietyName, Quantity, Purchase_Date, Phone_Num, Order_Purpose\r\n"
    		   + "FROM \"SEED\" INNER JOIN \"ORDER\" ON VarietyID = OD_VarietyID INNER JOIN \"USER\" ON OD_UserID = UserID\r\n"
    		   + "WHERE OD_OrgName = '" + OrgName + "'";
       ...
       while (rs.next()) {
          ...
          String OrderPurpose = rs.getString(8);
          ...
          if (OrderPurpose.equals("R")) { %>
              ...
              <form action="deleteOrderList.jsp" method="post">
                  ...
                  대여한 고객 전화번호
                  <input type="text" name="OrgName" class="text" placeholder="<%=PhoneNumber %>" readonly><br>
