    ...
    <form action="" name="frm">
    	<div>
        	<select name="sortlist" onchange="location=document.frm.sortlist.value">
            	<option value="userMainAllYear.jsp">정렬 방식</option>
            	...
            	<option selected value="userMainAllYear.jsp">일년 인기순</option>
        	</select><br>
    	</div>
    </form>
    			...
    			+ "FROM(\r\n"
    			     ...
    			     + "FROM (\r\n"
    			           ...
    			           + "FROM (\r\n"
    			                 ...
    			                 + "FROM \"ORDER\" OD FULL OUTER JOIN \"SEED\" S ON OD.OD_VarietyID = S.VarietyID))\r\n"
    			           + "WHERE Purchase_Date > TO_CHAR(SYSDATE - 365, 'YYYY-MM-DD')\r\n"
